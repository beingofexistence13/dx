...
passport_statergy.map((statergies) => {
  passport_statergies = `{title:"${statergies.title}",href:"docs/hack(passports)/${statergies.title.toLowerCase()}",github_repository:"${statergies.href}",description:"Not Provided(coming soon)",logo:"${statergies.logo}",items:[]},`
