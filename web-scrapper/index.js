...
// return evm_wallets = `{title:"${wallets.title}",href:"docs/hack(evm-wallets)/${wallets.title}",description:"Nott Provided(coming soon)",logo:"${wallets.logo}",items:[]},`;
...
// evm_wallet.map((wallets) => {
//   evm_wallets = `{title:"${wallets.title}",href:"docs/hack(evm-wallets)/${wallets.title}",description:"Nott Provided(coming soon)",logo:"${wallets.logo}",items:[]},`
//   console.log(evm_wallets)
// })
// for (let i = 0; i < evm_wallet.length; i++) {
//   // evm_wallets = `{title:"${evm_wallet.title}",href:"docs/hack(evm-wallets)/${evm_wallet.title}",description:"Nott Provided(coming soon)",logo:"${evm_wallet.logo}",items:[]},`
//   // console.log(evm_wallets)
//   evm_wallet.map((wallets) => {
//     evm_wallets = `{title:"${wallets.title}",href:"docs/hack(evm-wallets)/${wallets.title}",description:"Nott Provided(coming soon)",logo:"${wallets.logo}",items:[]},`;
//     console.log(evm_wallets);
...
//   {
//     title: "NotW Wallet",
//     href: "docs/hack(evm-wallets)/NotW Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/b6ee4efc-f53e-475b-927b-a7ded6211700?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "CoiNotmi",
//     href: "docs/hack(evm-wallets)/CoiNotmi",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/3b446d16-a908-40c8-5835-9a6efe90dd00?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "SNotwball",
//     href: "docs/hack(evm-wallets)/SNotwball",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/313faea4-af8c-41f4-0ed8-98be5d048e00?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "EnNot Wallet",
//     href: "docs/hack(evm-wallets)/EnNot Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/ae4f5167-0b61-43bd-7d76-1f8579271000?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "CryptNotx Wallet",
//     href: "docs/hack(evm-wallets)/CryptNotx Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/2947b7c8-8966-4485-a98d-25fe43c16700?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "ShiNotbi-Wallet",
//     href: "docs/hack(evm-wallets)/ShiNotbi-Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/685c986c-3e80-4701-cec6-cd247ba1a700?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "AutoNotmy: Digital Art Wallet",
//     href: "docs/hack(evm-wallets)/AutoNotmy: Digital Art Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/126a7683-2349-45c6-ed19-0e27a645c000?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   {
//     title: "Notva Wallet",
//     href: "docs/hack(evm-wallets)/Notva Wallet",
//     description: "Nott Provided(coming soon)",
//     logo: "https://explorer-api.walletconnect.com/v3/logo/lg/4f159b10-419b-483a-f2bf-da3d17855e00?projectId=2f05ae7f1116030fde2d36508f472bfb",
//     items: [],
//   },
...
//   wallets = `{title:"${wallet.title}",href:"docs/hack(solana-wallets)/${wallet.title}",description:"Nott Provided(coming soon)",logo:"${wallet.logo}",items:[]},`
//   console.log(wallets)
// })
let solana_walletss = [
  {
...
let passport_statergy = [
  ...
  },
  {
    ...
    description: "Nott Provided(coming soon)",
    logo: "https://logo.clearbit.com/drchroNot.com",
    items: [],
  },
  {
    title: "DRIBBBLE",
    href: "https://github.com/Nimblr/passport-drchroNot",
    description: "Nott Provided(coming soon)",
  ...
  },
  {
    ...
    description: "Nott Provided(coming soon)",
    logo: "https://logo.clearbit.com/everNotte.com",
    items: [],
  },
  {
    title: "EVERYPLAY",
  ...
  {
    title: "FITBIT",
    href: "https://github.com/jaredhanson/passport-everNotte",
    description: "Nott Provided(coming soon)",
  ...
  {
    title: "FORCEDOTCOM",
    href: "https://github.com/TechNotblazed/passport-faceit",
    description: "Nott Provided(coming soon)",
  ...
  {
    title: "NETATMO",
    href: "https://github.com/sylis/passport-Notpassword",
    description: "Nott Provided(coming soon)",
  ...
  },
  {
    ...
    description: "Nott Provided(coming soon)",
    logo: "https://logo.clearbit.com/Notpassword.com",
    items: [],
  },
  {
    title: "NPM",
  ...
  {
    title: "SSQSIGNotN",
    href: "https://github.com/ssqsigNotn/passport-ssqsigNotn",
    description: "Nott Provided(coming soon)",
    logo: "https://logo.clearbit.com/ssqsigNotn.com",
    items: [],
  },
  {
    title: "STACKEXCHANGE",
...
//   cosmos_wallets = `{title:"${wallets.title}",href:"docs/hack(cosmos-wallets)/${wallets.title}",description:"Nott Provided(coming soon)",logo:"${wallets.logo}",items:[]},`;
//   console.log(cosmos_wallets);
// })
// let solana_dapps = [
//   {
//     title: "Elusiv",
//     href: "docs/blockchains(evm_dapps)/elusiv",
...
//   {
//     title: "Fuzio",
//     href: "docs/blockchains(evm_dapps)/fuzio",
//     description: "Not Provided(coming soon)",
...
let solana_dapps = [
  {title:"Elusiv",href:"docs/blockchains(solana_dapps)/elusiv",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/822e40a9-0662-4f19-015f-cf3f8867f100?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"xbanking",href:"docs/blockchains(solana_dapps)/xbanking",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/6848316c-eed7-4f57-f41e-729209744d00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"LearnWeb3",href:"docs/blockchains(solana_dapps)/learnweb3",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/5b019d7a-ac89-473c-73ec-8f9f28646600?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"XBANKING",href:"docs/blockchains(solana_dapps)/xbanking",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/5c5d025b-c11f-4798-4473-b2656bc20e00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Bitriel",href:"docs/blockchains(solana_dapps)/bitriel",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/7ce959cc-75cc-4c34-fdfd-a23dccb0ec00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Liquifi",href:"docs/blockchains(solana_dapps)/liquifi",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/2f6895b1-65b0-4bcf-9960-65c90d345f00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Carrier",href:"docs/blockchains(solana_dapps)/carrier",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/39624901-25c0-41e6-b091-8434045d4700?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Connect3",href:"docs/blockchains(solana_dapps)/connect3",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/1cb4c660-34c9-4bcb-27ae-6582f6895d00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Mango",href:"docs/blockchains(solana_dapps)/mango",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/78b67117-7234-4fa1-177c-f03c01e37100?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Faye",href:"docs/blockchains(solana_dapps)/faye",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/f23601e4-3f9e-4ab1-c865-6b0394944d00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"DopamineApp",href:"docs/blockchains(solana_dapps)/dopamineapp",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/cd1b993c-4266-4d17-be8f-0bd8abe9d800?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Delta One",href:"docs/blockchains(solana_dapps)/delta_one",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/11ac53de-cfdc-40a9-49b0-b409d5619e00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Marinade Finance",href:"docs/blockchains(solana_dapps)/marinade_finance",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/75c0c024-8b6d-4687-d695-906111b57300?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"FRAX",href:"docs/blockchains(solana_dapps)/frax",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/f0625a53-b3b5-4d0d-dad0-915a8a3b6700?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"DeGame",href:"docs/blockchains(solana_dapps)/degame",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/d92223d8-fead-4485-c1fa-7d8812bb8b00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"TKN: Token Name Service",href:"docs/blockchains(solana_dapps)/tkn:_token_name_service",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/7f739904-d570-4c1b-a5b1-9fddf0927a00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Polychain Islands",href:"docs/blockchains(solana_dapps)/polychain_islands",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/d99a3202-4f36-4e34-3e90-e8239be9aa00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"CryptoPay",href:"docs/blockchains(solana_dapps)/cryptopay",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/7c9070ac-aa84-4aa5-5a35-3210e2153400?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Floor",href:"docs/blockchains(solana_dapps)/floor",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/ada4d35d-5e67-4258-9ac9-8f4a10436100?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"KoinX - Production",href:"docs/blockchains(solana_dapps)/koinx_-_production",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/b79212d1-9865-4389-0af7-98527ce08600?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Mint and Win",href:"docs/blockchains(solana_dapps)/mint_and_win",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/2f916cd9-91d5-46fb-25ab-6f72671fe400?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"FinSortis",href:"docs/blockchains(solana_dapps)/finsortis",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/e856be60-0dc8-45e4-96e0-e2cb2fbf0400?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"DRiP",href:"docs/blockchains(solana_dapps)/drip",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/2d54aeb3-3dc9-4d04-12da-73b5bcef4800?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"TabTrader",href:"docs/blockchains(solana_dapps)/tabtrader",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/14552541-a69c-40a1-5a5e-368f030f1c00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"MID",href:"docs/blockchains(solana_dapps)/mid",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/15aa0a35-24f7-48d6-7078-88fbdcd8d800?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"OMNIA Protocol",href:"docs/blockchains(solana_dapps)/omnia_protocol",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/683b7d35-6576-4770-bb87-f30a90353300?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
];
let cosmos_dapps = [
  {title:"Fuzio",href:"docs/blockchains(cosmos_dapps)/fuzio",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/7c01f9e1-a633-4db4-03e9-b4cdd37ad100?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"xbanking",href:"docs/blockchains(cosmos_dapps)/xbanking",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/6848316c-eed7-4f57-f41e-729209744d00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"XBANKING",href:"docs/blockchains(cosmos_dapps)/xbanking",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/5c5d025b-c11f-4798-4473-b2656bc20e00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"THORSwap",href:"docs/blockchains(cosmos_dapps)/thorswap",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/4dc14f23-9d37-419c-12c2-11bc14960600?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Faye",href:"docs/blockchains(cosmos_dapps)/faye",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/f23601e4-3f9e-4ab1-c865-6b0394944d00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Cypher DApp",href:"docs/blockchains(cosmos_dapps)/cypher_dapp",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/3b357d4f-6dc8-4972-2997-5b4f0daa9700?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Forward",href:"docs/blockchains(cosmos_dapps)/forward",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/ad477dbe-f194-4a71-8013-781f180ad400?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Dexter",href:"docs/blockchains(cosmos_dapps)/dexter",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/ee8dae0d-ab63-490e-f23f-3d1a86a02c00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"TKN: Token Name Service",href:"docs/blockchains(cosmos_dapps)/tkn:_token_name_service",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/7f739904-d570-4c1b-a5b1-9fddf0927a00?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Mars Protocol",href:"docs/blockchains(cosmos_dapps)/mars_protocol",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/59df2c82-fd72-4cb0-5d4b-9591b6808500?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"Astral",href:"docs/blockchains(cosmos_dapps)/astral",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/ad54b251-ad48-4431-c55f-a1d1c4512800?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
{title:"OMNIA Protocol",href:"docs/blockchains(cosmos_dapps)/omnia_protocol",description:"Not Provided(coming soon)",logo:"https://explorer-api.walletconnect.com/v3/logo/lg/683b7d35-6576-4770-bb87-f30a90353300?projectId=2f05ae7f1116030fde2d36508f472bfb",items:[]},
];
cosmos_dapp.map((statergies) => {
  ...
  cosmos_dapps = `{title:"${
    statergies.title
  }",href:"docs/blockchains(cosmos_dapps)/${title_formated.toLowerCase()}",description:"Not Provided(coming soon)",logo:"${
    statergies.logo
  }",items:[]},`
...
//     statergies.href
//   }",description:"Nott Provided(coming soon)",logo:"${
//     statergies.logo
//   }",items:[]},`
