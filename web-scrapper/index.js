...
//   let github_repo_formated = statergies.title.replace(/\s+/g, "not provided")
//   cosmos_dapps = `{title:"${
//     statergies.title
...
//             `{title:"${
//               statergies.title
//             }",description:"${`This ${statergies.title} passport statergy is quite popular amoung developers but it is recommended to checkout the github repo in order to use it!!!`}",download:"0",star:"0",github_repo:"${"https://github.com/jaredhanson/passport"}",version:"${"0.0.1"}",updated:"${"yesterday"}",items:[]},`
//           )
...
//   //   let title_formated = statergies.title.replace(/\s+/g, "-")
//   //   let github_title_formated = statergies.title
//   //     .replace(/\s+/g, "not provided")
//   //     .toLowerCase()
//   //   // let url = `${statergies.url}`
//   //   axios
//   //     .get(statergies.url)
//   //     .then((response) => {
//   //       const html = response.data
...
//   //         "div.card-header p"
//   //       )
//   //       let desctiption = description_element ? description_element.innerText : `This ${statergies.title} generator is one of the hard work from cssPortal`;


//   //       let result = `{title: "${statergies.title}",href:"${statergies.url}",description: "${desctiption}",website_url: "${statergies.website_url}", github_repo: "${`https://github.com/${github_title_formated}`}",items: [],},`
//   //       console.log(result)
//   //       // console.log("This",statergies.title,"is from this website!!!")

//   //     })
//   //     .catch((error) => {
//   //       console.log("Error:",statergies.title)
//   //       // console.log(`{title: "${statergies.title}",href:"https://www.cssportal.com/",description: "This ${statergies.title} generator is one of the hard work from cssPortal",website_url: "https://www.cssportal.com/", github_repo: "${`https://github.com/${github_title_formated}`}",items: [],},`)
...
//   .replace(/\s+/g, "not provided")
//   .toLowerCase()
//   let desctiption = `This ${statergies.title} generator is one of the hard work from cssPortal`;
...
// })
// cosmos_dapps.map((statergies, index) => {
//   setTimeout(() => {
//     let title_formated = statergies.title.replace(/\s+/g, "-")
//     let github_title_formated = statergies.title
//       .replace(/\s+/g, "not provided")
...
//         let websiteElement = document.querySelector(
//           ".styles_linkContainer__LpFnL a:nth-child(1)"
//         )
//         let appStoreElement = document.querySelector(
//           ".styles_linkContainer__LpFnL a:nth-child(2)"
//         )
//         let googlePlayStoreElement = document.querySelector(
//           ".styles_linkContainer__LpFnL a:nth-child(3)"
//         )
//         let chromeWebStoreElement = document.querySelector(
//           ".styles_linkContainer__LpFnL a:nth-child(4)"
//         )

//         let website_url = websiteElement
//           ? websiteElement.href
//           : "https://apps.apple.com/app/id1456732565/"
//         let appStore_url = appStoreElement
//           ? appStoreElement.href
//           : "https://apps.apple.com/app/id1456732565/"
//         let googleplayStore_url = googlePlayStoreElement
//           ? googlePlayStoreElement.href
//           : "https://play.google.com/store/apps/details?id=io.zerion.android&hl=en&gl=US/"
//         let chromewebStore_url = chromeWebStoreElement
//           ? chromeWebStoreElement.href
//           : "https://chrome.google.com/webstore/detail/zerion-wallet-for-web3-nf/klghhnkeealcohjjanjjdaeeggmfmlpl/"

//         let result = `{title: "${
//           statergies.title
//         }",description: "${description}",website_url: "${website_url}", github_repo: "${`https://github.com/${github_title_formated}`}",appStore_url: "${appStore_url}",googleplayStore_url: "${googleplayStore_url}",chromewebStore_url: "${chromewebStore_url}",items: [],},`
//         console.log(result)
//       })
//       .catch((error) => {
//         errorPage.push({ page: statergies.title })
//         console.error(
//           `{title:"${statergies.title}",description:"${
//             statergies.title
//           } Try Catch Error",website_url:"https://${
//             statergies.title
//           }.com",github_repo:"${`https://github.com/${github_title_formated}`}",appStore_url:"https://apps.apple.com/app/id1456732565/",googleplayStore_url:"https://play.google.com/store/apps/details?id=io.zerion.android&hl=en&gl=US/",chromewebStore_url:"https://chrome.google.com/webstore/detail/zerion-wallet-for-web3-nf/klghhnkeealcohjjanjjdaeeggmfmlpl/",items:[],},`
//         )
//       })
//   }, index * 5) // delay of 1 second
// })
...
// });
  ...
  //   let website_url = item.website_url;
  //   let github_repo = item.github_repo;
  ...
  //   console.log(arr)
  // });
// passport_statertgies_details.forEach((item)=>{
//   let arr = [];
//   let title = item.title;
//   let href = `docs/hack(passports)/${item.title}`;
//   let description = item.description;
//   let website_url = "https://www.passportjs.org/";
//   let github_repo = item.github_repo;
...
let walletConnect = [
  [
    ...
    },
    {
      ...
      href: "docs/blockchains(evm_dapps)/xraid",
      description: "Not Provided(coming soon)",
      logo: "https://explorer-api.walletconnect.com/v3/logo/lg/147d614d-b2e1-45df-da