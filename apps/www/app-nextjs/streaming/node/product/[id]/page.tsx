...
} from '#/app-nextjs/streaming/_components/recommended-products';
import { Reviews, ReviewsSkeleton } from '#/app-nextjs/streaming/_components/reviews';
import { SingleProduct } from '#/app-nextjs/streaming/_components/single-product';
