...
! function (n, e) {
  ...
  return en.version = "3.2.1", en.speed = 1, en.suspendWhenDocumentHidden = !0, en.running = K, en.remove = function (n) {
      ...
      <div className="status-panel absolute bottom-0 right-0 z-[1000000000000000000000000000000000000000000000000000000] flex h-auto w-full flex-row items-center justify-between text-xs">
        ...
        <div className="status-panel z-[1000000000000000000000000000000000000000000000000000000] flex h-auto w-auto flex-row items-center justify-between space-x-3 rounded-tl-xl border-l border-t px-1.5 py-1 text-xs">
