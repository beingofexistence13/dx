...
const UserLayout = () => {
  ...
  return (
    <div>
      ...
      {/* status action */}
      {/* <div className="status-action fixed bottom-0 left-[50%] hidden h-[40px] w-[750px] translate-x-[-50%] flex-row items-center justify-center rounded-t-lg border-x border-t py-1 text-xs lg:flex">
        Status Action
        <div
