  ...
  return (
    <div>
      ...
      {/* <div className="status-panel absolute bottom-0 right-0 flex h-auto w-auto flex-row items-center justify-between space-x-3 rounded-tl-xl border-l border-t px-2 py-1 text-xs">
        <h1 className="rounded-md p-1 text-center hover:bg-[--code-foreground] flex items-center justify-center">50 backlinks</h1>
        <h1 className="rounded-md p-1 text-center hover:bg-[--code-foreground] flex items-center justify-center">99+ words</h1>
        <h1 className="rounded-md p-1 text-center hover:bg-[--code-foreground] flex items-center justify-center">13 caracters</h1>
      </div> */}
