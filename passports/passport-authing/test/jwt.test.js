...
var expectations = {
  ...
  issuer: 'https://tokens-test.authing.cn/',
  nonce: 'a1b2c3d4e5',
  clock: Date.now()
};
...
describe('jwt.verify', function() {
  ...
  it('should throw when the expected issuer is not in the claim', function(done) {
    var EXPECTED_ERROR_MESSAGE = 'Issuer (iss) claim mismatch in the ID token; expected "ExpectedIssuer", found "https://tokens-test.authing.cn/"';
    try {
