...
function Strategy(options, verify) {
  options = options || {};
  options.issuer = 'https://api.vivokey.com/openid';
  options.authorizationURL = 'https://api.vivokey.com/openid/authorize/';
  options.tokenURL = 'https://api.vivokey.com/openid/token/';
  options.userInfoURL = 'https://api.vivokey.com/openid/userinfo/';
...
Strategy.prototype._getOAuth2Client = function (config) {
  return new OAuth2(config.clientID, config.clientSecret,
                    '', 'https://api.vivokey.com/openid/authorize/', 'https://api.vivokey.com/openid/token/');
}
