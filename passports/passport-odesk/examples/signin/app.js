var express = require('express')
  ...
  , util = require('util')
  , odeskStrategy = require('./../../lib/passport-odesk').Strategy;

var odesk_API_KEY = '3f448b92c4aaf8918c0106bd164a1656'; //"--insert-odesk-consumer-key-here--";
var odesk_API_SECRET =  "e6a71b4f05467054";//"--insert-odesk-consumer-secret-here--";
...
//   have a database of user records, the complete odesk profile is serialized
//   and deserialized.
...
// Use the odeskStrategy within Passport.
//   Strategies in passport require a `verify` function, which accept
//   credentials (in this case, a token, tokenSecret, and odesk profile), and
//   invoke a callback with a user object.
passport.use(new odeskStrategy({
    consumerKey: odesk_API_KEY,
    consumerSecret: odesk_API_SECRET,
