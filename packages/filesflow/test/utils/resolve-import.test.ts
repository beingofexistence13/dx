...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/beingofexistence/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/beingofexistence/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/beingofexistence/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/beingofexistence/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/beingofexistence/Projects/foobar/lib/utils")
})
