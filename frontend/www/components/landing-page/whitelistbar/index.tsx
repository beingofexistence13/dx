...
const Whitelistbar = () => {
  ...
  // const scroll =  useMotionValueEvent(scrollY, "change", (latest) => {
  //   console.log("Page scroll: ", latest)
  // })

  return (
    <div className="hover:text-green-400  h-12 max-w-[90%] w-[650px] fixed bottom-0 left-[50%] translate-x-[-50%] z-30">
