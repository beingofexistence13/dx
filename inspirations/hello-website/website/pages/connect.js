...
export default function Home() {
    ...
    <ul id="navbar_ul" className="navbar_ul">
      ...
      <div className="navbar_right" id="navbar_right">
        ...
        {/* <li class="pnt_li navbar_list balance_list blockchain_balance_nav navbar_li pnt_li4">
                      ...
                      <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/hello/website/public/blockchain/etherium.jpg" alt="e" class="blockchain_provider_name">
                      <h3 class="blockchain_balance">Thailand</h3>
                      <ion-icon name="chevron-down-outline"></ion-icon>
                      <h2 class="NT">Address</h2>
        ...
        <li className="connect_wallet madarchod_thailand_launch_button_container pnt_li navbar_list balance_list blockchain_balance_nav navbar_li pnt_li4">
          {/* <img src="https://cdn.jsdelivr.net/gh/Man-from-earth25/hello/website/public/blockchain/etherium.jpg" alt="e" class="blockchain_provider_name"> */}
          <h3 className="blockchain_wallet_address madarchod_thailand_launch_button_item blockchain_address">Connect Wallet</h3>
          {/* <ion-icon name="chevron-down-outline"></ion-icon> */}
          {/* <h2 class="NT">Blockchain Balance</h2> */}
        </li>
  ...
  <main className="M">
    ...
    <div id="main_container" className="space-y-0.5 main_container">
      ...
      {/* <div class="madarchod_thailand_welcome">
             <div class="madarchod_thailand_welcome_top">
                 
                 <h1>Play Boll To Win It All</h1>
                 <h3>
                     
                     Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, impedit.
                     
                 </h3>
                 
             </div>
             <div class="madarchod_thailand_welcome_center">
                 
                 <div class="madarchod_thailand_welcome_center_left_big">
                     <div class="madarchod_thailand_welcome_center_left_small"></div>
                 </div>
                 <div class="madarchod_thailand_welcome_center_center_big">
                     <div class="madarchod_thailand_welcome_center_center_small"></div>
                 </div>
                 <div class="madarchod_thailand_welcome_center_right_big">
                     <div class="madarchod_thailand_welcome_center_right_small"></div>
                 </div>
                 
             </div>
             <div class="madarchod_thailand_welcome_bottom">
                 
                 <div class="madarchod_thailand_welcome_bottom_launch_button">
                     Launch App
                 </div>
      ...
      <div className="player_container">
        <div className="player_name_container">
          <h1>Choose Player Name</h1>
          <div className="player_name">
            <input type="search" className="player_name_input" name="player_name_input" id="player_name_input" />
            <h2>Name</h2>
          </div>
