...
export default function Home() {
      ...
      <Head>
       ...
       <title>BattleBall</title>
        ...
        <Script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js" />
          ...
          <div className="mobile_landscaper">
  ...
  <nav id="navbar N" className="navbar ">
    <ul id="navbar_ul" className="navbar_ul">
      <div className="navbar_left" id="navbar_left">
        ...
        <li className="player_banner pnt_li navbar_list address_list blockchain_address_nav navbar_li pnt_li4">
          <h2>Thailand</h2>
        ...
        <li className="pnt_li navbar_list theme_list navbar_li pnt_li4 ">
          <div id="pnt_it5" className="pnt_it">
            <ion-icon name="person-add" /> 
            <h2 className="NT">Add A Friend</h2>
          </div>
        </li>
        <li className="pnt_li navbar_list theme_list navbar_li pnt_li4 ">
          <div id="pnt_it5" className="pnt_it">
            <ion-icon name="settings" />
            <h2 className="NT">Settings</h2>
          </div>
        </li>
        <li className="pnt_li navbar_list theme_list navbar_li pnt_li4 ">
          <div id="pnt_it5" className="pnt_it">
            <ion-icon name="mail" />
            <h2 className="NT">Notifications</h2>
          </div>
        </li>
      ...
      <div className="navbar_right" id="navbar_right">
        ...
        <li id="profile_toggler" className="pnt_li navbar_list profile_list navbar_li pnt_li4">
          <div className="pnt_it">
            {/* <ion-icon name="log-in"></ion-icon> */}    
            <ion-icon name="person" />
            <h2 className="NT">Profile</h2>
          </div>
        </li>
      </div>
    </ul>
  ...
  <main className="M">
    ...
    <div id="main_container" className="space-y-0.5 main_container">
      <div className="wallet_not_connect">
