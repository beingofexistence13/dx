  ...
  return (
    <div className="container relative">
      ...
      <PageHeader className=" ">
        ...
        <PageHeaderHeading>Build your dreamed component library.</PageHeaderHeading>
        <PageHeaderDescription>
          Beautifully designed components and developer resources that you can use into your
          Websites. Accessible. Customizable. Open Source.
        </PageHeaderDescription>
        <div className="flex w-full items-center space-x-4 pb-8 pt-4 md:pb-10">
          <Link href="/docs" className={cn(buttonVariants())}>
            Get Started
