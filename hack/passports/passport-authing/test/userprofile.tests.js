var authingProfile = require('./fixtures/authing-example-profile');
var authingProfileNoIdentites = require('./fixtures/authing-example-profile-no-identities');
var authingOIDCProfile = require('./fixtures/authing-oidc-example-profile');
var Profile = require('../lib/Profile');

describe('Standard profiles', function () {
  [authingProfile, authingProfileNoIdentites, authingOIDCProfile].forEach(function(profile) {
    before(function () {
