var chai = require('chai')
  , FanfouStrategy = require('../lib/strategy');
...
describe('Strategy', function() {
  ...
  describe('constructed', function() {
    ...
    it('should be named fanfou', function() {
      expect(strategy.name).to.equal('fanfou');
    });
  })
  ...
  describe('constructed with undefined options', function() {
    it('should throw', function() {
      expect(function() {
        var strategy = new FanfouStrategy(undefined, function(){});
      }).to.throw(Error);
    });
  })
    ...
    before(function(done) {
      chai.passport.use(strategy)
        ...
        .req(function(req) {
          ...
          req.session['oauth:fanfou']['oauth_token'] = 'x-hh5s93j4hdidpola';
